...
echo "127.0.0.1		localhost.localdomain localhost" >> "$file_path"/"$old_file_name"
...
rm "$file_path"/"$old_file_name"
touch "$file_path"/"$old_file_name"
echo "port=53" >> "$file_path"/"$old_file_name" 
...
echo "no-resolv" >> "$file_path"/"$old_file_name" 
#echo "server=$ipaddr" >> "$file_path"/"$old_file_name" 
echo "server=8.8.8.8" >> "$file_path"/"$old_file_name"
echo "local=/z.ctf/" >> "$file_path"/"$old_file_name" 
